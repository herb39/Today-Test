...
export const goalStyleTest: TestDefinition = {
  ...
  seo: {
    ...
    faq: [
      {
        question: '작심삼일이 반복되는 이유를 이 테스트로 알 수 있나요?',
        answer:
          '작심삼일도 하나의 목표 달성 스타일로 다뤄요. 왜 자꾸 불이 꺼지는지 원인을 분석하기보다는, 나만의 리듬을 있는 그대로 이해하고 다음번엔 어떻게 이어가면 좋을지 가볍게 힌트를 얻어가는 테스트예요.',
      },
      {
        question: '목표 달성 스타일 테스트는 얼마나 걸리나요?',
        answer: '질문은 총 11개이고, 하나씩 편하게 고르다 보면 3분 안에 나만의 스타일을 확인할 수 있어요.',
      },
      {
        question: '결과가 매번 똑같이 나오나요?',
        answer:
          '이 테스트는 재미와 자기 이해를 위한 콘텐츠라 정해진 정답은 없어요. 그때그때 목표나 컨디션에 따라 답이 조금씩 달라질 수 있으니, 부담 없이 여러 번 해봐도 좋아요.',
      },
    ],
  },
  questions: [

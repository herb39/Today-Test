...
export const soloLivingTest: TestDefinition = {
  ...
  seo: {
    ...
    faq: [
      {
        question: '나의 자취 생활 스타일은 어떻게 확인할 수 있나요?',
        answer:
          '냉장고 속 모습, 저녁 메뉴를 정하는 습관, 청소와 설거지를 대하는 태도 등 11가지 질문에 답하면 정리왕형, 배달음식 마스터형, 자급자족 요리형, 미니멀 생존형, 홈카페 감성형 중 나의 자취 캐릭터를 찾을 수 있어요.',
      },
      {
        question: '테스트는 얼마나 걸리나요?',
        answer: '총 11개의 질문으로 구성되어 있어서 평균 3분이면 편하게 끝낼 수 있어요.',
      },
      {
        question: '결과가 내 살림 실력을 평가하는 건가요?',
        answer:
          '살림 능력을 평가하는 테스트가 아니라, 재미로 보는 가벼운 자가 점검용 콘텐츠예요. 요즘 생활 패턴에 따라 결과가 달라질 수 있으니 부담 없이 즐겨주세요.',
      },
    ],
  },
  questions: [

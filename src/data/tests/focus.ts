...
export const focusTest: TestDefinition = {
  ...
  seo: {
    ...
    faq: [
      {
        question: '나에게 맞는 집중 스타일은 어떻게 찾나요?',
        answer:
          '배경 소음에 대한 반응, 마감이 다가올 때의 태도, 몰입이 깨졌을 때 회복하는 방식 등을 바탕으로 깊은 몰입형, 짧은 스프린트형, 환경 반응형, 마감 점화형 중 나와 가장 가까운 집중 스타일을 알려드려요.',
      },
      {
        question: '테스트는 얼마나 걸리나요?',
        answer: '11개 질문으로 구성돼 있고 평균 4분 정도면 끝낼 수 있어요.',
      },
      {
        question: '결과가 정확한가요?',
        answer:
          '이 테스트는 재미로 보는 자기 이해 콘텐츠로, 심리학적 진단을 대신하지 않아요. 그날의 컨디션이나 업무 환경에 따라 결과가 달라질 수 있으니 참고용으로 가볍게 즐겨주세요.',
      },
    ],
  },
  questions: [

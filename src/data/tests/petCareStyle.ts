...
export const petCareStyleTest: TestDefinition = {
  ...
  seo: {
    ...
    faq: [
      {
        question: '반려동물이 아직 없는데 이 테스트를 해도 되나요?',
        answer:
          '네, 전혀 문제없어요. 모든 질문이 "만약 키운다면"이라는 가정으로 되어 있어서, 지금 반려동물이 없어도 평소 성향을 떠올리며 편하게 답하면 돼요.',
      },
      {
        question: '집사 스타일 테스트는 얼마나 걸리나요?',
        answer: '총 11개의 질문으로 구성되어 있고, 평균적으로 3분이면 끝까지 답하고 결과를 확인할 수 있어요.',
      },
      {
        question: '결과가 나의 실제 반려동물 성향과 다를 수도 있나요?',
        answer:
          '이 테스트는 재미와 자기 이해를 위한 콘텐츠예요. 그날그날 기분이나 상황에 따라 결과가 달라질 수 있으니, 정답이라기보다는 나를 돌아보는 가벼운 참고로 봐주세요.',
      },
    ],
  },
  questions: [

...
export const workDinnerTest: TestDefinition = {
  ...
  seo: {
    ...
    faq: [
      {
        question: '회식 자리에서 나만 유독 불편한 걸까요?',
        answer:
          '아니에요. 회식을 즐기는 정도와 방식은 사람마다 다른 성향 차이일 뿐이에요. 이 테스트는 분위기 메이커형부터 얼른 집에 가고 싶은형까지, 회식이나 모임에서 자연스럽게 드러나는 캐릭터를 재미로 짚어봐요.',
      },
      {
        question: '테스트는 얼마나 걸리나요?',
        answer: '질문은 총 11개이고, 평균 소요 시간은 3분 정도예요. 회식을 앞두고 가볍게 풀어보기 좋은 길이예요.',
      },
      {
        question: '결과가 실제 내 모습과 다를 수도 있나요?',
        answer:
          '그럴 수 있어요. 이 테스트는 재미와 공감을 위한 콘텐츠일 뿐 성격을 딱 잘라 규정하는 진단은 아니에요. 그날의 자리나 분위기에 따라 결과도 얼마든지 달라질 수 있어요.',
      },
    ],
  },
  questions: [

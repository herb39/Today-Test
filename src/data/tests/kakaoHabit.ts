...
export const kakaoHabitTest: TestDefinition = {
  ...
  seo: {
    ...
    faq: [
      {
        question: '카톡 답장 속도만으로 성향을 알 수 있나요?',
        answer:
          '답장 속도뿐 아니라 이모티콘 사용, 읽씹 습관, 통화 선호도 같은 여러 상황에서의 선택을 종합해서 결과를 도출해요. 그래서 단순히 답장이 빠르고 느린 것보다 훨씬 다양한 카톡 습관을 함께 살펴볼 수 있어요.',
      },
      {
        question: '테스트는 얼마나 걸리나요?',
        answer: '11개 질문으로 구성되어 있어 평균 3분이면 충분히 끝낼 수 있어요. 친구와 결과를 비교해보면 더 재밌게 즐길 수 있어요.',
      },
      {
        question: '결과가 매번 똑같이 나오나요?',
        answer:
          '그날 기분이나 상황에 따라 선택이 달라지면 결과도 바뀔 수 있어요. 이 테스트는 재미로 보는 가벼운 자가 점검용 콘텐츠이니 결과에 너무 얽매이지 않아도 괜찮아요.',
      },
    ],
  },
  questions: [

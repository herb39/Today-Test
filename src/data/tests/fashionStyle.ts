...
export const fashionStyleTest: TestDefinition = {
  ...
  seo: {
    ...
    faq: [
      {
        question: '내 패션 스타일을 잘 모르겠는데, 옷을 잘 안 사는 편이어도 할 수 있나요?',
        answer:
          '그럼요. 옷을 자주 사는지보다 옷장을 열 때, 쇼핑할 때 어디에 먼저 시선이 가는지를 묻는 질문들이라, 평소 습관을 떠올리며 편하게 고르면 나에게 맞는 답이 나와요.',
      },
      {
        question: '패션 감각 테스트는 얼마나 걸리나요?',
        answer: '11개 질문으로 구성되어 있어서, 대부분 3분 안에 끝까지 답하고 결과를 확인할 수 있어요.',
      },
      {
        question: '결과가 실제 내 스타일과 다르게 느껴지면 어떡하죠?',
        answer:
          '이 테스트는 재미와 자기 이해를 위한 콘텐츠라 절대적인 정답은 아니에요. 그날의 기분이나 상황에 따라 결과가 다르게 나올 수 있으니 가볍게 즐기면서 참고해주세요.',
      },
    ],
  },
  questions: [

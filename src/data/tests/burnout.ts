...
export const burnoutTest: TestDefinition = {
  ...
  seo: {
    ...
    faq: [
      {
        question: '번아웃 자가진단은 어떻게 하나요?',
        answer:
          '월요일 아침 기분, 퇴근 후 모습, 주말을 보내는 방식 등 11개의 질문에 솔직하게 답하면 지금 내 에너지 상태가 페이스메이커형, 조용한 방전형, 열정 과열형, 방전 직전형, 재충전 모드형 중 어디에 가까운지 확인할 수 있어요.',
      },
      {
        question: '테스트는 얼마나 걸리나요?',
        answer: '11개 질문으로 구성돼 있어 평균 3분이면 부담 없이 끝낼 수 있어요.',
      },
      {
        question: '결과가 정확한가요?',
        answer:
          '이 테스트는 의학적 진단이 아니라, 최근 나의 컨디션을 다정하게 점검해보는 가벼운 자가 점검 콘텐츠예요. 요즘 컨디션에 따라 결과가 달라질 수 있으니 지금의 나를 돌아보는 참고 정도로 봐주세요.',
      },
    ],
  },
  questions: [

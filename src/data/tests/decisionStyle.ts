...
export const decisionStyleTest: TestDefinition = {
  ...
  seo: {
    ...
    faq: [
      {
        question: '결정 스타일 테스트로 무엇을 알 수 있나요?',
        answer:
          '메뉴, 쇼핑, 여행지 선택 등 일상적인 상황에서 내가 결정을 내리는 방식을 즉흥 결단형, 신중 비교형, 조언 의존형, 고민 즐기는형 네 가지로 나누어 알려드려요.',
      },
      {
        question: '테스트는 얼마나 걸리나요?',
        answer: '11개 질문으로 구성돼 있어 평균 3분 정도면 끝낼 수 있어요. 직관적으로 답할수록 더 빠르게 결과를 확인할 수 있어요.',
      },
      {
        question: '결과가 매번 다르게 나올 수도 있나요?',
        answer:
          '네, 그날그날 상황이나 기분에 따라 답이 조금씩 달라질 수 있어요. 재미로 나의 결정 습관을 되돌아보는 콘텐츠이니 결과에 너무 얽매이지 않아도 괜찮아요.',
      },
    ],
  },
  questions: [
